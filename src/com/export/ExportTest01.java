...
public class ExportTest01 {
	...
	public static void main(String[] args) throws IOException {
		...
		FileOutputStream out = new FileOutputStream("m:\\success1.xls");
		...
		sheetlist = setHSSFPrompt(sheetlist, "promt Title05", "prompt Content05",0, 500, 5, 5);// 第二列的前501行都设置提示.
		
		wb.write(out);
		out.close();
		System.out.println("----执行完毕----ExportTest01------");
	}
